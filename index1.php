 ...
 <body onload="Materialize.toast('Welcome,<br>1.Sign up<br>2.Login<br>3.Register for the events of your choice<br>4.It is enough for 1 individual to register this team for group events<br>5.Please add your name as well to team members list when you register for team events<br>6.Just click on the register button to register for individual events', 4000)">
  ...
  <section id="competition" ng-controller="EventsController as events">
        ...
        <nav>
          <div class="nav-wrapper">
            ...
            <ul id="top" class="right hide-on-med-and-down">
              <li><a href="profilep.php" class="waves-effect waves-light btn">Profile <?php  ?></a></li>
      ...
      <nav>
        <div class="nav-wrapper">
          ...
          <ul class="right hide-on-med-and-down">
            ...
            <li><a href="profilep.php" class="waves-effect waves-light btn"><?php echo $login_session;?>'s Profile <?php  ?></a></li>
            <li><a href="logout.php" class="waves-effect waves-light btn">Sign Out</a></li> 
          </ul>
    ...
    <div>
      ...
      <img id="e1" class="events" src="images/FIFA.png">
      <button id="b1" data-target="modal1" class="btn">+</button>
    </div>
    <div>
      <img id="e2" class="events" src="images/ChannelSurfing.png">
      <button id="b2" data-target="ev2" class="btn">+</button>

    </div>
    <div>
      <img id="e3" class="events" src="images/AdaptTunes.png">
      <button id="b3" data-target="ev3" class="btn">+</button>

    </div>
    <div>
      <img id="e4" class="events" src="images/COD.png">
      <button id="b4" data-target="ev4" class="btn">+</button>
...
<div id="modal1" class="modal modal-fixed-footer">
 <form action="eventReg.php" method="GET"> 
   <div class="modal-content">

    <h4>FIFA</h4>
    <input type="hidden" name="event" value="fifa">
    <div class="sec1">          
      Venue: CS Lab<br>
...
<div id="ev2" class="modal modal-fixed-footer">
 <form action="channel.php" method="GET"> 
  ...
  <div class="modal-content">
    ...
    <input type="hidden" name="event" value="channelSurfing">
    <div class="sec1">
    ...
    <h5>Registration</h5>
    <div>2-5 members</div>
    <label> Team name:<input type="text" name="tname" required/></label>
    <label> Team member 1:<input type="text" name="m1" required/></label>
    <label> Team member 2:<input type="text" name="m2" required/></label>
    <label> Team member 3:<input type="text" name="m3" placeholder="optional"/></label>
    <label> Team member 4:<input type="text" name="m4" placeholder="optional"/></label>
    <label> Team member 5:<input type="text" name="m5" placeholder="optional" /></label>
...
<div id="ev3" class="modal modal-fixed-footer">
 <form action="eventReg.php" method="GET"> 
  ...
  <div class="modal-content">
    <h4>Adapt Tunes</h4>
    <input type="hidden" name="event" value="adaptTunes">
    <div class="sec1">
...
<div id="ev4" class="modal modal-fixed-footer">
 <form action="cod.php" method="GET"> 
  ...
  <div class="modal-content">
    ...
    <label> Team member 1:<input type="text" name="m1" required/></label>
    <label> Team member 2:<input type="text" name="m2" required/></label>
    <label> Team member 3:<input type="text" name="m3" required /></label>
    <label> Team member 4:<input type="text" name="m4" required/></label>
    <label> Team member 5:<input type="text" name="m5" required /></label>
...
<div id="ev5" class="modal modal-fixed-footer">
 <form action="cricket.php" method="GET"> 

  <div class="modal-content">
    <h4>Cricket</h4>
    <input type="hidden" name="cricket" value="cricket">
    <div class="sec1">
    ...
    <label> Team member 4:<input type="text" name="m4" required/></label>
    <label> Team member 5:<input type="text" name="m5" required /></label>
    <label> Team member 6:<input type="text" name="m6" required /></label>
    <p class="sec2">
     Rules:<br>       
          *Six per team<br>
...
<div id="ev6" class="modal modal-fixed-footer">
 <form action="foosball.php" method="GET"> 

  <div class="modal-content">

    <!-- **********************************-->
    <h4>Foosball</h4>
    <input type="hidden" name="foosball" value="foosball">
    <div class="sec1">
      Venue: OAT<br>
    ...
    <label> Team member 5:<input type="text" name="m5" required /></label>
    <label> Team member 6:<input type="text" name="m6" required /></label>
    <label> Team member 7:<input type="text" name="m7" required /></label>
    <label> Team member 8:<input type="text" name="m8" placeholder="Optional substitute" /></label>
    <label> Team member 9:<input type="text" name="m9" placeholder="Optional substitute" /></label>
...
<div id="ev7" class="modal modal-fixed-footer">
  ...
  <div id="ev8" class="modal modal-fixed-footer">
   <form action="groupDance.php" method="GET"> 
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="groupDance" value="groupDance">
      <label> Team name:<input type="text" name="tname" required/></label>
      <label> Team Members:<input type="text" name="m1" placeholder="Enter all team member names separated by commas, Minimum 3 people"required/></label>
    ...
    <div id="ev9" class="modal modal-fixed-footer">
     <form action="masterchef.php" method="GET"> 

      <div class="modal-content">
        <h4>Masterchef</h4>
        <input type="hidden" name="masterchef" value="masterchef">
        <div class="sec1">
    ...
    <form action="bandMusic.php" method="GET"> 
      ...
      <div class="modal-content">
        ...
        <input type="hidden" name="bandMusic" value="bandMusic">
        <label> Team name:<input type="text" name="tname" required/></label>
        <label> Team Members:<input type="text" name="m1" placeholder="Enter all team member names separated by commas, Minimum 3 people"required/></label>
    ...
    <div id="ev11" class="modal modal-fixed-footer">
     <form action="eventReg.php" method="GET"> 
      ...
      <div class="modal-content">
        ...
        <input type="hidden" name="event" value="photography">
    ...
    <div id="ev13" class="modal modal-fixed-footer">
     <form action="eventReg.php" method="GET"> 
      ...
      <div class="modal-content">
        <h4>Shipwreck</h4>
        <input type="hidden" name="event" value="shipwreck">
    ...
    <div id="ev14" class="modal modal-fixed-footer">
     <form action="eventReg.php" method="GET"> 
      ...
      <div id="ev15" class="modal modal-fixed-footer">
        <form action="treasurehunt.php" method="GET"> 

          <div class="modal-content">
            <h4>Treasure Hunt</h4>
            <input type="hidden" name="treasureHunt" value="treasureHunt">
            <div class="sec1">
              Venue: EG Hall<br>
         ...
         <div class=".input-field">
           <form action="signup.php" method="GET"> 
             <div class="modal-content">
              ...
              <label>Username:<input type="text" name="sign_user_name" required /></label>
              <label>Password:<input type="password" name="sign_pass" required/></label>
